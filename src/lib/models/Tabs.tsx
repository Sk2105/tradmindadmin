...
import { LuLayoutDashboard, LuLogOut, LuMessageCircleMore, LuUsers } from 'react-icons/lu'; // Replace 'some-module-path' with the actual path to the module
import { RiFeedbackLine } from 'react-icons/ri';
import { TbCategory } from 'react-icons/tb';

enum TAB {
    Dashboard,Product,Category,Users,Orders,Feedbacks,Enquiries,LogOut
}
...
const tabList = [
    ...
    {label:"LogOut",value:TAB.LogOut,icon:<LuLogOut />}
]
