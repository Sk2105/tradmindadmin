...
function VisitorCard() {
    ...
    return (
        <div className="p-4 bg-blue-600/10 w-[200px] rounded-md ">
...
function RecentOrder() {
    return ( 
        <div className="p-4 bg-blue-600/10 w-full place-content-center flex flex-col justify-center items-center
         rounded-xl">
            <h1 className='w-full '>Recent Orders</h1>

            {Array.from({ length: 5 }, (_, i) => (
                <div key={i} className="h-fit w-full rounded-lg items-center flex justify-between transition-all">
                    <div className='flex flex-row gap-4 items-center w-fit h-[80px]'>
